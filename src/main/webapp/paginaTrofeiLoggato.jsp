                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
                                            <div class="rounded ">
                                                <div class="d-flex flex-column align-items-center text-center">
                                                    <img src="assets/img/profiloUtente/trofeo%20bloccato.png" class="rounded-circle" width="150">
                                                    <h5> <a href="#" style="color: white">45 Partecipazioni ad eventi </a></h5>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- End -->
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
                                            <div class="rounded ">
                                                <div class="d-flex flex-column align-items-center text-center">
                                                    <img src="assets/img/profiloUtente/trofeo%20bloccato.png" class="rounded-circle" width="150">
                                                    <h5> <a href="#" style="color: white">50 Partecipazioni ad eventi </a></h5>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- End -->
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
                                            <div class="rounded ">
                                                <div class="d-flex flex-column align-items-center text-center">
                                                    <img src="assets/img/profiloUtente/trofeo%20bloccato.png" class="rounded-circle" width="150">
                                                    <h5> <a href="#" style="color: white">55 Partecipazioni ad eventi </a></h5>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- End -->
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
                                            <div class="rounded ">
                                                <div class="d-flex flex-column align-items-center text-center">
                                                    <img src="assets/img/profiloUtente/trofeo%20bloccato.png" class="rounded-circle" width="150">
                                                    <h5> <a href="#" style="color: white">60 Partecipazioni ad eventi </a></h5>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- End -->
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
                                            <div class="rounded ">
                                                <div class="d-flex flex-column align-items-center text-center">
                                                    <img src="assets/img/profiloUtente/trofeo%20bloccato.png" class="rounded-circle" width="150">
                                                    <h5> <a href="#" style="color: white">65 Partecipazioni ad eventi </a></h5>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- End -->
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
                                            <div class="rounded ">
                                                <div class="d-flex flex-column align-items-center text-center">
                                                    <img src="assets/img/profiloUtente/trofeo%20bloccato.png" class="rounded-circle" width="150">
                                                    <h5> <a href="#" style="color: white">70 Partecipazioni ad eventi </a></h5>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- End -->
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
                                            <div class="rounded ">
                                                <div class="d-flex flex-column align-items-center text-center">
                                                    <img src="assets/img/profiloUtente/trofeo%20bloccato.png" class="rounded-circle" width="150">
                                                    <h5> <a href="#" style="color: white">75 Partecipazioni ad eventi </a></h5>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- End -->
