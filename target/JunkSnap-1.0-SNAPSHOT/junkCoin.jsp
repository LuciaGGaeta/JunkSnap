                    ...
                    <div class="card" style="border: none">
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                <img src="assets/img/junkCoin/Nuovo%20progetto.jpg" height="400">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="popScroll" style="display:none;" id="popup">
        <div class="popup">
            ...
            <div class="subscribe-widget">
                ...
                <div id="codice">
                    <h5>Non puoi riscattare il buono <br> perchè non hai effettuato il login!</h5>
